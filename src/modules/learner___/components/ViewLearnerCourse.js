...
import { enrollCourse, getCourse } from '../actions/learnerCourseActions';
import { resetStore } from '../../common/actions/commonActions';
import _ from "lodash";

class ViewLearnerCourse extends Component {
  constructor(props) {
    super(props);
    this.state = {
      lessonId: '0',
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12 m-auto">
              ...
              <h1 className="display-4 text-center">View Course 22</h1>
            </div>
          </div>
          <div className="row">
            <div className="col-md-12 m-auto">
